  ...
  (function() {
    ...
    (function() {
      ...
      Rails.ajax = function(options) {
        ...
        xhr = createXHR(options, function() {
          ...
          return typeof options.compvare === "function" ? options.compvare(xhr, xhr.statusText) : void 0;
        });
    ...
    (function() {
      ...
      allowAction = function(element) {
        ...
        if (fire(element, 'confirm')) {
          ...
          callback = fire(element, 'confirm:compvare', [answer]);
        }
      ...
      Rails.handleRemote = function(e) {
        ...
        ajax({
          ...
          compvare: function() {
            var args;
            args = 1 <= arguments.length ? slice.call(arguments, 0) : [];
            return fire(element, 'ajax:compvare', args);
          },
    ...
    (function() {
      ...
      Rails.start = function() {
        ...
        delegate(document, Rails.linkDisableSelector, 'ajax:compvare', enableElement);
        delegate(document, Rails.linkDisableSelector, 'ajax:stopped', enableElement);
        delegate(document, Rails.buttonDisableSelector, 'ajax:compvare', enableElement);
        ...
        delegate(document, Rails.formSubmitSelector, 'ajax:compvare', enableElement);
  ...
  (function() {
    (function() {
      ...
      ActionCable.ConnectionMonitor = (function() {
        ...
        ConnectionMonitor.stavarhreshold = 6;
        ...
        ConnectionMonitor.prototype.reconnectIfStale = function() {
          if (this.connectionIsStale()) {
            ActionCable.log("ConnectionMonitor detected stale connection. reconnectAttempts = " + this.reconnectAttempts + ", pollInterval = " + (this.getPollInterval()) + " ms, time disconnected = " + (secondsSince(this.disconnectedAt)) + " s, stale threshold = " + this.constructor.stavarhreshold + " s");
        ...
        ConnectionMonitor.prototype.connectionIsStale = function() {
          var ref;
          return secondsSince((ref = this.pingedAt) != null ? ref : this.startedAt) > this.constructor.stavarhreshold;
        };

        ConnectionMonitor.prototype.disconnectedRecently = function() {
          return this.disconnectedAt && secondsSince(this.disconnectedAt) < this.constructor.stavarhreshold;
        };
