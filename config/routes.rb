Rails.application.routes.draw do
  ...
  get 'api/v1/crime_states/:id/most_dangerous_cities', to: "api/v1/crime_states/most_dangerous_cities#index"
  get 'api/v1/safest_cities', to: "api/v1/safest_cities#index"
  get 'api/v1/crime_states/:id/safest_cities', to: "api/v1/crime_states/safest_cities#index"
